...
{
    public class TeachersModelValidations:AbstractValidator<TeachersModel>
    {
        public TeachersModelValidations()
        {
            RuleFor(x => x.Teacher_Name).NotEmpty().WithMessage("Teacher Name is Required")
            ...
            RuleFor(x => x.Teacher_Cnic).NotEmpty().WithMessage("Cnic is required")
